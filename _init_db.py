...
from app.models import User, Note, Comment, Tag
...
async def insert_data():
    async with async_session() as sess:
        ...
        #         n1 = Notes(title="Error handling",
        #                    content="""Pydantic will raise a ValidationError exception whenever it finds an error in the data it's validating.
